...
/*!
  ...
  the file will be called datumSurface.ini and will be stored in a directory called ABE.config.  On Linux, the
...
#ifdef NVWIN3X
  QString ini_file = QString (getenv ("USERPROFILE")) + "/ABE.config/datumSurface.ini";
#else
  QString ini_file = QString (getenv ("HOME")) + "/ABE.config/datumSurface.ini";
#endif

  QSettings settings (ini_file, QSettings::IniFormat);
  settings.beginGroup ("datumSurface");
