  ...
  QWizardPage (parent)
{
  ...
  progress->pbox = new QGroupBox (tr ("Processing input data"), this);
  QVBoxLayout *pboxLayout = new QVBoxLayout;
  progress->pbox->setLayout (pboxLayout);
  pboxLayout->setSpacing (10);


  progress->pbar = new QProgressBar (this);
  progress->pbar->setRange (0, 100);
  progress->pbar->setWhatsThis (tr ("Progress of input data processing."));
  pboxLayout->addWidget (progress->pbar);


  vbox->addWidget (progress->pbox);


  progress->wbox = new QGroupBox (tr ("Writing CHRTR2 output file"), this);
  ...
  progress->wbar->setWhatsThis (tr ("Progress of writing CHRTR2 output file."));
